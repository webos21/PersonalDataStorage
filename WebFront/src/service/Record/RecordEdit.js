...
const RecordEdit = props => {
    ...
    const onDelete = () => {
        fetch(REQ_URI + '?recordId=' + props.dataFromParent.id, {
            method: 'DELETE',
            ...
            console.log("RecordDel::fetch => " + resJson.result);
            if (resJson.result === "OK") {
                props.modalToggle();
                props.callbackFromParent();
            }
        }).catch(function (error) {
            console.log("RecordDel::fetch => " + error);
    ...
    const onSubmit = (data, e) => {
        ...
        fetch(REQ_URI, {
            ...
            console.log("RecordEdit::fetch => " + resJson.result);
            if (resJson.result === "OK") {
                props.modalToggle();
                props.callbackFromParent(resJson.data[0]);
            }
        }).catch(function (error) {
            console.log("RecordEdit::fetch => " + error);
                ...
                <CModalBody>
                    <CFormGroup row>
                        <CCol xs="12" md="12">
                            <Controller
                                name="recordId"
                                key={"recordId" + props.dataFromParent.id}
                                control={control}
                            ...
                            <CInputGroup>
                                ...
                                />
                                {errors.recordId && <CInvalidFeedback>{errors.recordId.message}</CInvalidFeedback>}
