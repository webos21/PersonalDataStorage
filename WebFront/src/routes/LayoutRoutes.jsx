...
// render - pages
const Home = Loadable(lazy(() => import('../pages/home/index.jsx')));
const Test = Loadable(lazy(() => import('../pages/test/test.jsx')));

// const Dashboard = Loadable(lazy(() => import('../pages/Dashboard')));
const AccountClass = Loadable(lazy(() => import('../pages/AccountClass/AccountClass.jsx')));
const AccountCode = Loadable(lazy(() => import('../pages/AccountCode/AccountCode.jsx')));
