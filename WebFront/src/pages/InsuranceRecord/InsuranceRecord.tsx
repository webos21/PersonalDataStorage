...
import InsuranceRecordForm, { FIELD_CONFIG as InsuranceRecordFieldConfig } from './InsuranceRecordForm';
import InsuranceRecordColumns from './InsuranceRecordColumns';
import api from './api';
...
const InsuranceRecord = () => {
    ...
    const labelByKey = useMemo(
        () => Object.fromEntries(InsuranceRecordFieldConfig.map((field: any) => [field.name, field.label])),
        []
    );
    ...
    return (
        <PageLayout>
            <PageHeader icon={ScanHeart} title="보험기록" desc="보험 거래 기록 관리" iconClass="bg-blue-100 text-blue-600" />
            <div className="fms-table-wrap flex-1 flex flex-col relative">
                <TableToolbar
                    ...
                    searchPlaceholder="보험기록 검색 (Ctrl+K)"
                ...
                <DataTable
                    ...
                    data={rows}
                    isLoading={isLoading}
                    emptyMessage="등록된 보험기록 데이터가 없습니다."
                    manualSorting
                />
