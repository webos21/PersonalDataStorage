...
import RecordForm, { FIELD_CONFIG as RecordFieldConfig } from './RecordForm';
...
const Record = () => {
    ...
    const columns = useMemo(() => RecordColumns(tableKeys, labelByKey, openForm), [tableKeys, labelByKey]);
