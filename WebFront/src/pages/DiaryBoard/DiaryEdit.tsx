    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-lg shadow-xl w-[500px] overflow-hidden">
                <input type="hidden" {...register('diaryId')} defaultValue={props.dataFromParent.id} />
                <div className="p-4 border-b font-bold text-lg">일기 수정</div>
                <div className="p-6 space-y-4">
                    ...
                    <div className="flex flex-col">
                        ...
                        <Controller name="weather" control={control} defaultValue={props.dataFromParent.weather} render={({field}) => (
