...
import api from './api';
import { FIELD_CONFIG } from './RegularRecordField';
import type { FieldDef, FieldType } from './RegularRecordField';
...
const RegularRecordForm = ({ modalFlag, modalToggle, mode = 'add', dataFromParent, fieldKeys = [], idParam = 'rrId', entityLabel = '정기기록', callbackFromParent }: any) => {
...
export default RegularRecordForm;
