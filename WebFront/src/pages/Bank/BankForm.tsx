...
import api from './api';
import { FIELD_CONFIG } from './BankField';
import type { FieldDef, FieldType } from './BankField';
...
const BankForm = ({ modalFlag, modalToggle, mode = 'add', dataFromParent, fieldKeys = [], idParam = 'bankId', entityLabel = '계좌', callbackFromParent }: any) => {
