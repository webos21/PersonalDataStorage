...
import AnniversaryForm, { FIELD_CONFIG as AnniversaryFieldConfig } from './AnniversaryForm';
import AnniversaryColumns from './AnniversaryColumns';
import api from './api';
...
const Anniversary = () => {
    ...
    return (
        <PageLayout>
            <PageHeader icon={Calendar1} title="기념일" desc="기념일 정보 관리" iconClass="bg-blue-100 text-blue-600" />
            <div className="fms-table-wrap flex-1 flex flex-col relative">
                <TableToolbar
                    ...
                    searchPlaceholder="기념일 검색 (Ctrl+K)"
                ...
                <DataTable
                    ...
                    data={rows}
                    isLoading={isLoading}
                    emptyMessage="등록된 기념일 데이터가 없습니다."
                    manualSorting
                />
