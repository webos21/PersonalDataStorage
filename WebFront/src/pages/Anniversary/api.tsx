...
const ENDPOINT = '/anniversary';
const QUERY_KEY = 'anniversary';
const service = {
    ...
    async delete(id: string | number) { const response = await ApiClient.delete(ENDPOINT, { params: { anniId: id } }); return response.data?.deletedRows ?? 0; }
};
