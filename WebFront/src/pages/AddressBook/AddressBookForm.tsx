...
import api from './api';
import { FIELD_CONFIG } from './AddressBookField';
import type { FieldDef, FieldType } from './AddressBookField';
...
const AddressBookForm = ({ modalFlag, modalToggle, mode = 'add', dataFromParent, fieldKeys = [], idParam = 'abId', entityLabel = '주소록', callbackFromParent }: any) => {
