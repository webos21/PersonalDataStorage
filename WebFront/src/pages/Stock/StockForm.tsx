...
import api from './api';
import { FIELD_CONFIG } from './StockField';
import type { FieldDef, FieldType } from './StockField';
...
const StockForm = ({ modalFlag, modalToggle, mode = 'add', dataFromParent, fieldKeys = [], idParam = 'stockId', entityLabel = '주식계좌', callbackFromParent }: any) => {
