...
import api from './api';
import { FIELD_CONFIG } from './RealEstateRecordField';
import type { FieldDef, FieldType } from './RealEstateRecordField';
...
const RealEstateRecordForm = ({ modalFlag, modalToggle, mode = 'add', dataFromParent, fieldKeys = [], idParam = 'rerId', entityLabel = '부동산기록', callbackFromParent }: any) => {
...
export default RealEstateRecordForm;
