...
import RegularPayForm, { FIELD_CONFIG as RegularPayFieldConfig } from './RegularPayForm';
...
const RegularPay = () => {
    ...
    return (
        <PageLayout>
            <PageHeader icon={RefreshCcw} title="정기결제" desc="정기납입 정보 관리" iconClass="bg-blue-100 text-blue-600" />
            <div className="fms-table-wrap flex-1 flex flex-col relative">
                <TableToolbar
                    ...
                    searchPlaceholder="정기납입 검색 (Ctrl+K)"
                ...
                <DataTable
                    ...
                    data={rows}
                    isLoading={isLoading}
                    emptyMessage="등록된 정기납입 데이터가 없습니다."
                    manualSorting
                />
