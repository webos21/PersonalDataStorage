...
import api from './api';
import { FIELD_CONFIG } from './RegularPayField';
import type { FieldDef, FieldType } from './RegularPayField';
...
const RegularPayForm = ({ modalFlag, modalToggle, mode = 'add', dataFromParent, fieldKeys = [], idParam = 'rpId', entityLabel = '정기납입', callbackFromParent }: any) => {
