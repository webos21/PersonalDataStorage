...
const PbFormDel = props => {
    ...
    const onSubmit = (data, e) => {
        ...
        }).catch(error => setError("siteId", { message: error.message }));
    };
            ...
            {modalShow && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-lg shadow-xl w-[400px] overflow-hidden">
                        ...
                        <div className="p-4 border-b font-bold text-lg text-red-600">비밀번호 삭제</div>
                        <div className="p-6">
                            ...
                            <ul className="list-disc pl-5 text-sm space-y-1">
                                ...
                                <li>등 록 일 : {Utils.date.dateFormat(new Date(props.dataFromParent.regDate))}</li>
                            </ul>
