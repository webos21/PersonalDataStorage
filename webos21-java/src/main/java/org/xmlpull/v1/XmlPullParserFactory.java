...
public class XmlPullParserFactory {
	 ...
	 * @throws XmlPullParserException if a parser cannot be created which satisfies
	 ...
	 * pull parsers. The factory will always return instances of {@link KXmlParser}
	 * and {@link KXmlSerializer}.
	 */
	 ...
	 * creating arbitrary parser and serializer implementations. Both arguments to
	 * this method are unused.
	 */
	public static XmlPullParserFactory newInstance(String unused, @SuppressWarnings("rawtypes") Class unused2)
