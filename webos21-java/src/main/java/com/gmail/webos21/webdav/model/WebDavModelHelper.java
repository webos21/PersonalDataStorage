...
import com.gmail.webos21.webdav.WebDavConstants;
import com.gmail.webos21.webdav.WebDavException;
...
public class WebDavModelHelper {
	...
	static {
		try {
			...
			throw new WebDavException("webDAVFailSetupPropertyHelper", e); //$NON-NLS-1$
		}
	}
	...
	public static Marshaller createMarshaller() {
		try {
			...
			throw new WebDavException("webDAVFailCreateMarshaller", e); //$NON-NLS-1$
		}
	}
	...
	public static Unmarshaller createUnmarshaller() {
		try {
			...
			throw new WebDavException("webDAVFailCreateUnmarshaller", e); //$NON-NLS-1$
		}
	}
	...
	public static void marshal(Marshaller m, Object element, Writer writer, String elementName) {
		try {
			...
			throw new WebDavException("webDAVUnableToMarshalElement", e); //$NON-NLS-1$
		}
	}
	...
	public static <T> T unmarshal(Unmarshaller u, Reader reader, Class<T> elementClass, String elementName) {
		try {
			...
			if (!(elementClass.equals(object.getClass()))) {
				throw new WebDavException("webDAVIncompatibleTypeInRequest");
			}
			return (T) object;
		} catch (JAXBException e) {
			throw new WebDavException("webDAVUnableToParseElement", e); // $NON-NLS-1$
		}
	}
