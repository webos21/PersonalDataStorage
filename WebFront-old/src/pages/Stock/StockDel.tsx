            ...
            <CForm onSubmit={handleSubmit(onSubmit)}>
                <CModalBody>
                    ...
                    <ul>
                        ...
                        <li>예탁금액 : {Utils.num.formatDecimal(props.dataFromParent.deposit)}</li>
                        <li>산정금액 : {Utils.num.formatDecimal(props.dataFromParent.estimate)} (산정일 : {Utils.date.dateFormat(new Date(props.dataFromParent.estimateDate))})</li>
                    </ul>
                    <CFormGroup>
                        <Controller
                            name="stockId"
