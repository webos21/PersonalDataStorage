...
const StockEdit = props => {
    ...
    const onSubmit = (data, e) => {
        ...
        fetch(REQ_URI, {
            ...
            console.log("StockEdit::fetch => " + resJson.result);
            if (resJson.result === "OK") {
                props.modalToggle();
                props.callbackFromParent(resJson.data[0]);
            }
        }).catch(function (error) {
            console.log("StockEdit::fetch => " + error);
    ...
    return (
        <CModal show={props.modalFlag} onClose={props.modalToggle}
            ...
            <CModalHeader closeButton>주식계좌 수정</CModalHeader>
                        ...
                        <CCol xs="12" md="12">
                            <CInputGroup>
                                ...
                                <Controller
                                    name="estimateDate"
                                    control={control}
                                    defaultValue={Utils.date.dateFormat(new Date(props.dataFromParent.estimateDate))}
                                    render={({field}) => (
                                        <CInput
                                            type="date"
                                            name="estimateDate"
