                        ...
                        <CCol xs="12" md="12">
                            <CInputGroup>
                                ...
                                <Controller
                                    name="wdate"
                                    control={control}
                                    defaultValue={Utils.date.dateFormat(new Date(props.dataFromParent.wdate))}
                                    render={({field}) => (
                                        <CInput
                                            type="date"
                                            name="wdate"
                        ...
                        <CCol xs="12" md="12">
                            <CInputGroup>
                                ...
                                <Controller
                                    name="sdate"
                                    control={control}
                                    defaultValue={Utils.date.dateFormat(new Date(props.dataFromParent.sdate))}
                                    render={({field}) => (
                                        <CInput
                                            type="date"
                                            name="sdate"
                        ...
                        <CCol xs="12" md="12">
                            <CInputGroup>
                                ...
                                <Controller
                                    name="edate"
                                    control={control}
                                    defaultValue={Utils.date.dateFormat(new Date(props.dataFromParent.edate))}
                                    render={({field}) => (
                                        <CInput
                                            type="date"
                                            name="edate"
