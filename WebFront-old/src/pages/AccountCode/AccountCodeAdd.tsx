...
const AccountCodeAdd = (props) => {
    ...
    const onSubmit = (data, e) => {
        ...
        fetch(REQ_URI, { method: 'POST', headers: Utils.auth.makeAuthHeader(), body: formData })
            ...
            .catch(error => { console.log(error); setError('acodeId', { message: error.message }); });
    };
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="bg-gray-100 p-0 rounded-xl shadow-2xl w-[400px] overflow-hidden">
                ...
                <div className="p-6">
                    <div className="mb-4">
                        ...
                        <input {...register('acodeId')} defaultValue={props.dataFromParent?.accountCodeId} className={`w-full p-2 border rounded ${errors.acodeId ? 'border-red-500' : 'border-gray-300'}`} />
