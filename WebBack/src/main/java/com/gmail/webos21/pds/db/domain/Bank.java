...
public class Bank {
	...
	public Bank(Long id, String bankName, String accountName, String holder, String accountNumber, Long initialBalance,
			String accountPassword, Date issueDate, Date expireDate, Long arrange, Integer notUsed, String memo) {
		this.id = id;
	...
	public Bank(Long id, String bankName, String accountName, String holder, String accountNumber, Long initialBalance,
			String accountPassword, Long issueDate, Long expireDate, Long arrange, Integer notUsed, String memo) {
		this.id = id;
		this.bankName = bankName;
		this.accountName = accountName;
		this.holder = holder;
