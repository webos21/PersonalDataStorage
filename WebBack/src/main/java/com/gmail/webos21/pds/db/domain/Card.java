...
public class Card {
	...
	public Card(Long id, String company, String cardName, String cardNumber, String cardPassword, Integer validYear,
			Integer validMonth, Integer chargeDate, Integer cvcNumber, Long bankId, Long creditLimit, Long cashAdvance,
			Long cardLoan, Date issueDate, Integer refreshNormal, Integer refreshShort, Long arrange, String memo) {
		this.id = id;
	...
	public Card(Long id, String company, String cardName, String cardNumber, String cardPassword, Integer validYear,
			Integer validMonth, Integer chargeDate, Integer cvcNumber, Long bankId, Long creditLimit, Long cashAdvance,
			Long cardLoan, Long issueDate, Integer refreshNormal, Integer refreshShort, Long arrange, String memo) {
		this.id = id;
		this.company = company;
		this.cardName = cardName;
		this.cardNumber = cardNumber;
	...
	public String toJson() {
		...
		sb.append("  \"cardPassword\": \"").append(JsonHelper.escape(cardPassword)).append("\",\n");
