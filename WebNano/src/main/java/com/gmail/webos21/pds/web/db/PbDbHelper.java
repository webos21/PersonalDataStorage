...
import com.gmail.webos21.pds.web.h2.H2Database;
import com.gmail.webos21.pds.web.h2.H2OpenHelper;
...
public class PbDbHelper extends H2OpenHelper implements PbDbInterface {
	...
	public void onCreate(H2Database db) {
		if (Consts.DB_DEBUG) {
			com.gmail.webos21.pds.web.log.Log.d(TAG, "onCreate [" + getFilePath() + "]");
		}
	...
	public void onUpgrade(H2Database db, int oldVersion, int newVersion) {
		if (Consts.DB_DEBUG) {
			com.gmail.webos21.pds.web.log.Log.d(TAG, "onUpgrade [" + getFilePath() + "] oldVer = " + oldVersion + ", newVer = " + newVersion);
		}
	...
	private void debugDump(String tableName) {
		try {
			...
			if (Consts.DB_DEBUG) {
				com.gmail.webos21.pds.web.log.Log.d(TAG, sb.toString());
			}
