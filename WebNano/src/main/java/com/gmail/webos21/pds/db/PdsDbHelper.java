...
public class PdsDbHelper extends H2OpenHelper implements PdsDbInterface {
    ...
    private static final String CREATE_TB_ANNIVERSARY = // Indent
    ...
    private static final String CREATE_TB_BANK = // Indent
    ...
    private static final String CREATE_TB_BANK_RECORD = // Indent
    ...
    private static final String CREATE_TB_BUDGET = // Indent
    ...
    private static final String CREATE_TB_CARD = // Indent
    ...
    private static final String CREATE_TB_CARD_RECORD = // Indent
    ...
    private static final String CREATE_TB_DIARY = // Indent
    ...
    private static final String CREATE_TB_INSURANCE = // Indent
    ...
    private static final String CREATE_TB_INSURANCE_RECORD = // Indent
    ...
    private static final String CREATE_TB_MEMO = // Indent
    ...
    private static final String CREATE_TB_REALESTATE = // Indent
    ...
    private static final String CREATE_TB_REALESTATE_RECORD = // Indent
    ...
    private static final String CREATE_TB_RECORD = // Indent
    ...
    private static final String CREATE_TB_REGULAR_PAY = // Indent
    ...
    private static final String CREATE_TB_REGULAR_RECORD = // Indent
    ...
    private static final String CREATE_TB_SCHEDULE = // Indent
    ...
    private static final String CREATE_TB_STOCK = // Indent
    ...
    private static final String CREATE_TB_STOCK_RECORD = // Indent
    ...
    private static final String CREATE_TB_TITLES = // Indent
    ...
    private static final String DROP_TB_ACCOUNT_CLASS /* Indent---- */ = "DROP TABLE IF EXISTS " + TB_ACCOUNT_CLASS + ";";
    private static final String DROP_TB_ACCOUNT_CODE /* Indent----- */ = "DROP TABLE IF EXISTS " + TB_ACCOUNT_CODE + ";";
    private static final String DROP_TB_ADDRESSBOOK /* Indent------ */ = "DROP TABLE IF EXISTS " + TB_ADDRESSBOOK + ";";
    private static final String DROP_TB_ANNIVERSARY /* Indent------ */ = "DROP TABLE IF EXISTS " + TB_ANNIVERSARY + ";";
    private static final String DROP_TB_BANK /* Indent------------- */ = "DROP TABLE IF EXISTS " + TB_BANK + ";";
    private static final String DROP_TB_BANK_RECORD /* Indent------ */ = "DROP TABLE IF EXISTS " + TB_BANK_RECORD + ";";
    private static final String DROP_TB_BUDGET  /* Indent---------- */ = "DROP TABLE IF EXISTS " + TB_BUDGET + ";";
    private static final String DROP_TB_CARD  /* Indent------------ */ = "DROP TABLE IF EXISTS " + TB_CARD + ";";
    private static final String DROP_TB_CARD_RECORD /* Indent------ */ = "DROP TABLE IF EXISTS " + TB_CARD_RECORD + ";";
    private static final String DROP_TB_DIARY /* Indent------------ */ = "DROP TABLE IF EXISTS " + TB_DIARY + ";";
    private static final String DROP_TB_INSURANCE /* Indent-------- */ = "DROP TABLE IF EXISTS " + TB_INSURANCE + ";";
    private static final String DROP_TB_INSURANCE_RECORD /* Indent- */ = "DROP TABLE IF EXISTS " + TB_INSURANCE_RECORD + ";";
    private static final String DROP_TB_MEMO /* Indent------------- */ = "DROP TABLE IF EXISTS " + TB_MEMO + ";";
    private static final String DROP_TB_REALESTATE /* Indent ------ */ = "DROP TABLE IF EXISTS " + TB_REALESTATE + ";";
    private static final String DROP_TB_REALESTATE_RECORD /* Indent */ = "DROP TABLE IF EXISTS " + TB_REALESTATE_RECORD + ";";
    private static final String DROP_TB_RECORD /* Indent----------- */ = "DROP TABLE IF EXISTS " + TB_RECORD + ";";
    private static final String DROP_TB_REGULAR_PAY /* Indent------ */ = "DROP TABLE IF EXISTS " + TB_REGULAR_PAY + ";";
    private static final String DROP_TB_REGULAR_RECORD /* Indent--- */ = "DROP TABLE IF EXISTS " + TB_REGULAR_RECORD + ";";
    private static final String DROP_TB_SCHEDULE /* Indent--------- */ = "DROP TABLE IF EXISTS " + TB_SCHEDULE + ";";
    private static final String DROP_TB_STOCK /* Indent------------ */ = "DROP TABLE IF EXISTS " + TB_STOCK + ";";
    private static final String DROP_TB_STOCK_RECORD /* Indent----- */ = "DROP TABLE IF EXISTS " + TB_STOCK_RECORD + ";";
    private static final String DROP_TB_TITLES /* Indent----------- */ = "DROP TABLE IF EXISTS " + TB_TITLES + ";";
    ...
    public void onCreate(H2Database db) {
        ...
        db.execSQL(CREATE_TB_ACCOUNT_CLASS);
        db.execSQL(CREATE_TB_ACCOUNT_CODE);
        db.execSQL(CREATE_TB_ADDRESSBOOK);
        db.execSQL(CREATE_TB_ANNIVERSARY);
        db.execSQL(CREATE_TB_BANK);
        db.execSQL(CREATE_TB_BANK_RECORD);
        db.execSQL(CREATE_TB_BUDGET);
        db.execSQL(CREATE_TB_CARD);
        db.execSQL(CREATE_TB_CARD_RECORD);
        db.execSQL(CREATE_TB_DIARY);
        db.execSQL(CREATE_TB_INSURANCE);
        db.execSQL(CREATE_TB_INSURANCE_RECORD);
        db.execSQL(CREATE_TB_MEMO);
        db.execSQL(CREATE_TB_REALESTATE);
        db.execSQL(CREATE_TB_REALESTATE_RECORD);
        db.execSQL(CREATE_TB_RECORD);
        db.execSQL(CREATE_TB_REGULAR_PAY);
        db.execSQL(CREATE_TB_REGULAR_RECORD);
        db.execSQL(CREATE_TB_SCHEDULE);
        db.execSQL(CREATE_TB_STOCK);
        db.execSQL(CREATE_TB_STOCK_RECORD);
        db.execSQL(CREATE_TB_TITLES);
        db.execSQL(CREATE_TB_PASSWORD_BOOK);
    }

    private void dropTables(H2Database db) {
        db.execSQL(DROP_TB_ACCOUNT_CLASS);
        db.execSQL(DROP_TB_ACCOUNT_CODE);
        db.execSQL(DROP_TB_ADDRESSBOOK);
        db.execSQL(DROP_TB_ANNIVERSARY);
        db.execSQL(DROP_TB_BANK);
        db.execSQL(DROP_TB_BANK_RECORD);
        db.execSQL(DROP_TB_BUDGET);
        db.execSQL(DROP_TB_CARD);
        db.execSQL(DROP_TB_CARD_RECORD);
        db.execSQL(DROP_TB_DIARY);
        db.execSQL(DROP_TB_INSURANCE);
        db.execSQL(DROP_TB_INSURANCE_RECORD);
        db.execSQL(DROP_TB_MEMO);
        db.execSQL(DROP_TB_REALESTATE);
        db.execSQL(DROP_TB_REALESTATE_RECORD);
        db.execSQL(DROP_TB_RECORD);
        db.execSQL(DROP_TB_REGULAR_PAY);
        db.execSQL(DROP_TB_REGULAR_RECORD);
        db.execSQL(DROP_TB_SCHEDULE);
        db.execSQL(DROP_TB_STOCK);
        db.execSQL(DROP_TB_STOCK_RECORD);
        db.execSQL(DROP_TB_TITLES);
